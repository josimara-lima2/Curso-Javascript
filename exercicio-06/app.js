...
console.log(`O crazyArray tem ${qntBoolean} booleans, ${qntNumber} números e ${qntString} strings.`)
/*
  06
...
let randomNumbersPares = []
let randomNumbersImpares = []
for(let i = 0; i<randomNumbers.length; i++){
  if(randomNumbers[i] % 2 === 0){
    randomNumbersPares.push(randomNumbers[i])
  }else{
    randomNumbersImpares.push(randomNumbers[i])
  }
}
randomNumbersPares = randomNumbersPares.join(', ').replace(', 5', ' e 5')
randomNumbersImpares = randomNumbersImpares.join(', ').replace(', 3', ' e 3')

console.log(`Numeros ímpares: ${randomNumbersImpares}. Números pares: ${randomNumbersPares}.`)