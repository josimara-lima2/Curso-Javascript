...
const numberArrendondado = Math.ceil(firstNumber)
console.log(numberArrendondado)
/*
  05
...
const numberArrendondaPadrao = Math.round(secondNumber)
console.log(numberArrendondaPadrao)
/*
  06
...
const numberArrendondaBaixo = Math.floor(thirdNumber)
console.log(numberArrendondaBaixo)
/*
  07
...
*/
const numberAleatorio = Math.round(Math.random() * 10)
