...
let newName = name[0].toUpperCase() + name.slice(1, 7) + name[7].toUpperCase() + name.slice(8, 12)
    //console.log(newName)
...
newName = `${name[0].toUpperCase()}${name.slice(1,7)}${name[7].toUpperCase()}${name.slice(8,12)}`
console.log(newName)