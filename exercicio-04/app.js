...
*/
const my3FavoriteTVShows = ["Lucifer", "La casa de papel", "Toy boy"]
...
const result = String(typeSentence.length > NUMERO_DE_CARACTERES)
// console.log(`A string que a "typeSentence" armazena tem mais de ${NUMERO_DE_CARACTERES}  
// caracteres? ${result.charAt(0).toUpperCase()+result.slice(1)}.`)
...
//Por que null + 1 resulta em 1, e 1 em boolean representa true.
